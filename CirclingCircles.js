...
var ASM_CONSTS = {
  94868: () => { if (document.fullscreenElement) return 1; },  
 94914: () => { return document.getElementById('canvas').width; },  
 94966: () => { return parseInt(document.getElementById('canvas').style.width); },  
 95034: () => { document.exitFullscreen(); },  
 95061: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 95134: () => { if (document.fullscreenElement) return 1; },  
 95180: () => { return document.getElementById('canvas').width; },  
 95232: () => { return screen.width; },  
 95257: () => { document.exitFullscreen(); },  
 95284: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 95417: () => { return window.innerWidth; },  
 95443: () => { return window.innerHeight; },  
 95470: () => { if (document.fullscreenElement) return 1; },  
 95516: () => { return document.getElementById('canvas').width; },  
 95568: () => { return parseInt(document.getElementById('canvas').style.width); },  
 95636: () => { if (document.fullscreenElement) return 1; },  
 95682: () => { return document.getElementById('canvas').width; },  
 95734: () => { return screen.width; },  
 95759: () => { return window.innerWidth; },  
 95785: () => { return window.innerHeight; },  
 95812: () => { if (document.fullscreenElement) return 1; },  
 95858: () => { return document.getElementById('canvas').width; },  
 95910: () => { return screen.width; },  
 95935: () => { document.exitFullscreen(); },  
 95962: () => { if (document.fullscreenElement) return 1; },  
 96008: () => { return document.getElementById('canvas').width; },  
 96060: () => { return parseInt(document.getElementById('canvas').style.width); },  
 96128: () => { document.exitFullscreen(); },  
 96155: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 96213: () => { return screen.width; },  
 96238: () => { return screen.height; },  
 96264: () => { return window.screenX; },  
 96291: () => { return window.screenY; },  
 96318: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 96371: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 96442: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 96499: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96755: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 96826: () => { if (document.fullscreenElement) return 1; },  
 96872: () => { return window.innerWidth; },  
 96898: () => { return window.innerHeight; },  
 96925: () => { if (document.pointerLockElement) return 1; }
};
