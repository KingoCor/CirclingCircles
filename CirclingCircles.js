...
var ASM_CONSTS = {
  94852: () => { if (document.fullscreenElement) return 1; },  
 94898: () => { return document.getElementById('canvas').width; },  
 94950: () => { return parseInt(document.getElementById('canvas').style.width); },  
 95018: () => { document.exitFullscreen(); },  
 95045: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 95118: () => { if (document.fullscreenElement) return 1; },  
 95164: () => { return document.getElementById('canvas').width; },  
 95216: () => { return screen.width; },  
 95241: () => { document.exitFullscreen(); },  
 95268: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 95401: () => { return window.innerWidth; },  
 95427: () => { return window.innerHeight; },  
 95454: () => { if (document.fullscreenElement) return 1; },  
 95500: () => { return document.getElementById('canvas').width; },  
 95552: () => { return parseInt(document.getElementById('canvas').style.width); },  
 95620: () => { if (document.fullscreenElement) return 1; },  
 95666: () => { return document.getElementById('canvas').width; },  
 95718: () => { return screen.width; },  
 95743: () => { return window.innerWidth; },  
 95769: () => { return window.innerHeight; },  
 95796: () => { if (document.fullscreenElement) return 1; },  
 95842: () => { return document.getElementById('canvas').width; },  
 95894: () => { return screen.width; },  
 95919: () => { document.exitFullscreen(); },  
 95946: () => { if (document.fullscreenElement) return 1; },  
 95992: () => { return document.getElementById('canvas').width; },  
 96044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 96112: () => { document.exitFullscreen(); },  
 96139: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 96197: () => { return screen.width; },  
 96222: () => { return screen.height; },  
 96248: () => { return window.screenX; },  
 96275: () => { return window.screenY; },  
 96302: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 96355: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 96426: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 96483: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96739: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 96810: () => { if (document.fullscreenElement) return 1; },  
 96856: () => { return window.innerWidth; },  
 96882: () => { return window.innerHeight; },  
 96909: () => { if (document.pointerLockElement) return 1; }
};
